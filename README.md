...
- On first startup you may end up in a situation where UI scaling is incorrect. In that case, clicking on the video options in the main menu should fix it.
